...
import afloclient as client
from afloclient import _i18n
from afloclient import client_const
...
class OpenStackClientShell(object):
    ...
    def _append_global_identity_args(self, parser):
        ...
        parser.add_argument('--os-cacert',
                            ...
                            'Without this option looks for the '
        ...
        parser.add_argument(client_const.COMMAND_ARGS_OS_CLIENT_URL_NAME,
                            default=utils.env(
    ...
    def get_base_parser(self):
        ...
        if osprofiler_profiler:
            parser.add_argument('--profile',
                                ...
                                'component, it is specified in paste '
                                'configuration file at '
                                '/etc/used_comonent/api-paste.ini Without key '
    ...
    def _get_endpoint_and_token(self, args, force_auth=False):
        ...
        auth_reqd = force_auth or (utils.is_authentication_required(args.func)
                                   and not (auth_token and client_url))
        ...
        if not auth_reqd:
            ...
            service_type = \
                args.os_service_type or client_const.DEFAULT_SERVICE_TYPE

            endpoint = args.os_aflo_url or ks_session.get_endpoint(
    ...
    def do_bash_completion(self, _args):
        ...
        client.bash_completion script doesn't have to hard code them.
        """
        commands = set()
        options = set()
...
def main():
    try:
        OpenStackClientShell().main(map(encodeutils.safe_decode, sys.argv[1:]))
