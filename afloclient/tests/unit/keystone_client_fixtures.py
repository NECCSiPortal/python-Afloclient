...
AFLO_ENDPOINT = 'http://aflo.example.com/v1'
...
def _get_normalized_token_data(**kwargs):
    ...
    ref['aflo_url'] = ref.get('aflo_url', AFLO_ENDPOINT)
...
def generate_v2_project_scoped_token(**kwargs):
    ...
    # we only care about Aflo and Keystone endpoints
    o['access']['serviceCatalog'] = [
        {'endpoints': [
            {'publicURL': ref.get('aflo_url'),
             'id': uuid.uuid4().hex,
             'region': 'RegionOne'
             }],
         'endpoints_links': [],
