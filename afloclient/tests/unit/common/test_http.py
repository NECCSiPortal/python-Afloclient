...
from afloclient.common import https
...
class TestClient(testtools.TestCase):
    ...
    def test_identity_headers_are_passed(self):
        ...
        with mock.patch.object(http_client.session, 'request') as mreq:
            ...
            http_client.get('http://example.com:9292/v1/tickets/1')
    ...
    def test_connection_refused(self):
        ...
        self.mock.ReplayAll()
        try:
            self.client.get('/v1/tickets/detail?limit=20')
        ...
        except afloclient.exc.CommunicationError as comm_err:
    ...
    def test_http_encoding(self):
        ...
        resp, body = self.client.get('/v1/tickets/detail', headers=headers)
    ...
    def test_http_chunked_request(self):
        ...
        resp, body = self.client.post('/v1/tickets/',
    ...
    def test_http_json(self):
        ...
        def test_json(passed_data):
            ...
            :param passed_data: The data being
    ...
    def test_http_chunked_response(self):
        ...
        self.mock.ReplayAll()
        headers = {"test": u'chunked_request'}
        resp, body = self.client.get('/v1/tickets/')
...
class TestVerifiedHTTPSConnection(testtools.TestCase):
    """Test fixture for afloclient.common.http.VerifiedHTTPSConnection."""
